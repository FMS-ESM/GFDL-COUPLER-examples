#!/bin/csh -fv
#PBS -o /lustre/f1/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50/work/../stdout/
#PBS -N c96_hiram_sit_m2_5d5d5d_v0.50
...
setenv res 96
setenv model hiram
setenv suffix b2_p13b
setenv do_test .false.
setenv use_climo .true.
setenv do_sit .true.
setenv maskid 2
setenv sitArg 5d5d5d
setenv sit_suffix _sit_m2_5d5d5d
setenv scriptName runscript_c96_hiram_sit_m2_5d5d5d_v0.50.csh
setenv org .false.
...
setenv do_lin_cld_microphys .true.
...
# experiment name:
set name = c96_hiram_sit_m2_5d5d5d_v0.50
#set name = runs/${res}
...
# dir name:
  ...
  set dirName = runs/c96_hiram_sit_m2_5d5d5d_v0.50
  echo runs/c96_hiram_sit_m2_5d5d5d_v0.50

# fast scratch:
  set fscratch = /lustre/f1/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50

# long-term scratch:
  set lscratch = /lustre/f1/unswept/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50

# gfdl archive:
  set gfdl_archive = /archive/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50
...
# script name:
  set scriptFullName = /lustre/f1/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50/work/runscript_c96_hiram_sit_m2_5d5d5d_v0.50.csh
  set stdoutDir      = /lustre/f1/Benjei.Tsuang/tikal/runs/c96_hiram_sit_m2_5d5d5d_v0.50/work/../stdout
